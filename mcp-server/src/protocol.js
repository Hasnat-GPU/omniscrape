 ...
 *
 * IMPORTANT: this file is mirrored verbatim at `extension/shared/protocol.js`.
 * It is deliberately dependency-free and framework-free so the same source can
 * run in Node and in a Manifest V3 service worker. If you change a constant
